...
const LoadingSkeleton = () => (
  <div className="min-h-screen flex flex-col bg-white">
    <PageHeader
      title="Dashboard"
      subtitle="Welcome back! Here's your habit progress overview."
    />
    <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 pt-8 p-4">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center min-h-[140px] relative animate-pulse"
        >
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 pt-8 p-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center min-h-[140px] relative">
          <span className="absolute top-4 right-4 text-xl text-blue-500">
            🎯
          </span>
        ...
        {/* Current Streaks */}
        <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center min-h-[140px] relative">
          <span className="absolute top-4 right-4 text-xl text-orange-500">
            🔥
          </span>
          <h2 className="text-lg font-bold text-gray-700 mb-1">
            Current Streaks
        ...
        {/* Completion Rate */}
        <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center min-h-[140px] relative">
          <span className="absolute top-4 right-4 text-xl text-green-600">
            📈
          </span>
          <h2 className="text-lg font-bold text-gray-700 mb-1">
            Completion Rate
        ...
        {/* Days Tracked */}
        <div className="bg-white border border-gray-200 rounded-lg p-6 flex flex-col items-center min-h-[140px] relative">
          <span className="absolute top-4 right-4 text-xl text-purple-500">
            🗓️
          </span>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 px-8">
        ...
        <div className="md:col-span-2">
          <div className="border border-gray-200 rounded-2xl bg-white p-8 mb-4">
            ...
            <div className="text-gray-500 text-base mb-6 ml-9">
              Individual completion patterns for each of your habits
            </div>
            {safeHabits.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-gray-400 text-lg font-semibold gap-2">
                ...
                <span>
                  No habits yet. Your heatmap will appear here after you create
                  one!
                </span>
              </div>
            ) : (
                ...
                {safeHabits.slice(0, 4).map((habit) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <span
                        className={`text-2xl p-2 rounded-md bg-blue-100 mt-1`}
                      >
                        {habit.emoji}
                      </span>
                      <div className="flex flex-col flex-1">
                        ...
                        <div className="flex items-center gap-4 text-gray-500 text-base mb-2">
                          ...
                          <span>
                            • {habit.completionPercent}% completion rate
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        <div className="md:col-span-1">
          <div className="border border-gray-200 rounded-2xl bg-white p-6 mb-4">
            ...
            <div className="text-gray-500 text-base mb-6 ml-9">
              Your latest habit completions and updates
            </div>
            {safeRecentActivity.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-gray-400 text-lg font-semibold gap-2">
                ...
                <span>
                  No recent activity. Get moving and make some progress!
                </span>
              </div>
            ) : (
              <div className="flex flex-col gap-4">
                {safeRecentActivity.map((item, idx) => {
                  const habitEmoji =
                    safeHabits.find((h) => h.id === item.habitId)?.emoji ||
                    "❓";
                  return (
                    <div key={idx} className="flex items-center gap-3">
                      <span className={`text-2xl p-2 rounded-md bg-blue-100`}>
                        {habitEmoji}
                      </span>
                      <div className="flex flex-col flex-1">
                        <span className="font-semibold text-base text-gray-900">
                          ...
                          {item.status === "completed" ? (
                            <FaCheckCircle className="inline ml-1 text-green-500 w-4 h-4" />
                          ) : (
                            <FaTimesCircle className="inline ml-1 text-red-500 w-4 h-4" />
                          )}
                        </span>
